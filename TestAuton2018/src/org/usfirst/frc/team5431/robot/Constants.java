...
public final class Constants {
	...
	// Intake
	public final static int ENCODER_AUTONOMOUS_START_POSITION = 4111;
	public final static int ENCODER_INTAKE_UP_POSITION = 3900;//3550
	public final static int ENCODER_INTAKE_SWITCH_POSITION = 3000; //then 2500;
